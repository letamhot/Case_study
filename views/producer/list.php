    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td><img src="<?= 'data:image;base64,'.base64_encode($producer->image)?> " width="60px" height="60px"> </td>
                <td> <a href="producer.view.php?page=edit&id=<?php echo $producer->id; ?>" class="btn btn-info btn-sm">Update</a></td>
                <td> <a href="producer.view.php?page=delete&id=<?php echo $producer->id; ?>" class="btn btn-warning btn-sm">Delete</a></td>
                <?php endforeach; ?>
        </tbody>
    </table>
</body>
