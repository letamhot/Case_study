        ...
        <div class="col-12">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="name_producer" class="form-control" ><?php echo $producer->name_producer; ?></textarea>
                </div>
                <div class="form-group">
                    <label>Address</label>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="image" id="image">
                        <img src="<?= 'data:image;base64,'.base64_encode($producer->image)?> " width="60px" height="60px" >
                </div>
                <div class="form-group">
